...
public class GeraetControllerTest {
    ...
    public void setup() throws IOException {
        ...
        mvc = MockMvcBuilders.standaloneSetup(new GeraetController(geraetRepository,rentEventRepository,mailService,personService,geraetService,accountRepository,personRepository))
